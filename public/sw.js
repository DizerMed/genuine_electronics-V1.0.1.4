const CACHE_STATIC_NAME = 'genuine-static-v6';
const CACHE_DATA_NAME = 'genuine-data-v6';
const CACHE_IMAGES_NAME = 'genuine-images-v6';
...
self.addEventListener('fetch', (event) => {
  ...
  // 3. Product & Brand Images (Unsplash, Supabase Storage, local images) -> Cache First / Stale-While-Revalidate
